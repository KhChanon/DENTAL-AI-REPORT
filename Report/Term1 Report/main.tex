...
\textbf{SYMBOL}  & & \textbf{UNIT} \\[0.000001cm]
...
\newpage
  ...
  \section{ER Diagram}
    \begin{figure}[!h]
      \centering
      \fbox{\includegraphics[width=.5\textwidth]{Image/ER2.png}}
      \caption{ER-Diagram}\label{fig:ER}
      \begin{itemize}
        \item[] 1. User Object: This object includes userID, Username, Profilepic, and StatusMessage, all linked to the Line profile. Additionally, the User object contains lists of RecordObject and FollowUpObject.
        \item[] 2. Records Object: It encompasses RecordID, TimeStamp, SurgicalProcedure, and Status. The RecordID is linked to the User object. 
        \item[] 3. FollowUp Object: This object contains FollowUpID, Title, TimeStamp, Chat, and ChatResult. The FollowUpID is linked to the Record object in a one-to-one relation.
        \item[] 4. Chat Object: It includes ChatID, UserChat, TimeStamp, and Text. The ChatID is linked to the FollowUp object.   
  ...
  \section{User Interface}
    ...
    \subsection{Follow-Up page}
      \begin{figure}[!h]
        \centering
        \fbox{\includegraphics[width=.4\textwidth]{Image/Desk_Follow.png}}
        ...
        \begin{flushleft}
          ...
          \begin{itemize}
            \item Case History: Positioned on the left side of the page, this section displays the user’s case history. Users can click on specific cases to view their follow-up chat history. 
            \item Chat Box: Positioned in the middle of the page, this area hosts the ongoing chat conversation. User can engage in follow-up discussions within this section. 
    ...
    \begin{figure}[!h]
      ...
      \begin{flushleft}
        ...
        \begin{itemize}
          ...
          \item Hamburger Button Pressed (Right): Upon pressing the hamburger button, the keyboard input is dismissed, replaced by a long-closed button. This button allows users to return to the Follow-Up page.
        \end{itemize}
      \end{flushleft}
    \end{figure}
