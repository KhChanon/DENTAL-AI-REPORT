...
\newpage
  ...
  \section{Navigation Map}
    \begin{figure}[!h]
      \centering
      \fbox{\includegraphics[width=.6\textwidth]{Image/Navigation_Map.png}}
  ...
  \section{User Interface}
    ...
    \begin{figure}[!h]
      ...
      \begin{minipage}{.3\textwidth}
        \centering
        \fbox{\includegraphics[width=.5\linewidth]{Image/Mob_Home.png}}
      \end{minipage}
    ...
    \subsection{Follow-Up page}
      \begin{figure}[!h]
        \centering
        \fbox{\includegraphics[width=.5\textwidth]{Image/Desk_Follow.png}}
...
\newpage
    ...
    \begin{figure}[!h]
      \centering
      \fbox{\includegraphics[width=.6\textwidth]{Image/Desk_FAQ.png}}
